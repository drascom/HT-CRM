...
<div class="card">
    ...
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <a href="surgeries.php" class="btn btn-outline-dark btn-sm">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="me-3">
                    ...
                    <div id="status-edit-container" class="ms-1" style="display: none;">
                        ...
                        <button type="button" class="btn  btn-text text-success ms-1" id="save-status-btn" title="Save">
        ...
        <form id="surgery-form">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <fieldset class="border rounded p-3 mb-3 bg-light shadow-sm">
                        <legend class="w-auto px-2 mb-3" style="font-size: 1rem;">
                            <i class="far fa-hospital me-2"></i>Graft Count
                        </legend>
                        ...
                        data.rooms.forEach(room => {
                            if (room.is_active) { // Only show active rooms
                                ...
                                if (room.name.toLowerCase() === "consultation" || room.name.toLowerCase() === "cosmetology") {
                                    console.log("Room:", room.name.toLowerCase(), "ID:", room.id);
