...
<div class="container mt-4">
    ...
    <a href="add_edit_surgery.php?patient_id=<?php echo htmlspecialchars($patient_id); ?>" class="btn btn-success mb-3"><i class="fas fa-plus-circle me-1"></i>Add New Surgery</a>
